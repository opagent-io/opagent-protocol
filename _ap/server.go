...
func (ss *ServerSession) CallAgentWithLoop(ctx context.Context, params *CallAgentMessageParams) (*CreateMessageResult, error) {
...
func (ss *ServerSession) CallTool(ctx context.Context, params *CreateMessageParams) (*CreateMessageResult, error) {
	if err := ss.checkInitialized(methodCreateMessage); err != nil {
		return nil, err
	}
	if params == nil {
