...
type ClientOptions struct {
	...
	//
	// Setting CallAgentWithLoopHandler to a non-nil value causes the client to
	// advertise the callAgentWithLoop capability.
	CallAgentWithLoopHandler func(context.Context, *CallAgentMessageRequest) (*CallAgentMessageResult, error)
